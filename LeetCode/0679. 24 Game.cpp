...
public:
    bool judgePoint24(vector<int>& cards) {
        ...
        //lets go full bruteforce, but how? i can do without paranthesis but wiht?
        //why do i feel like i need something like dfs here
        //was thinking of implementing switch case too but not able to figure out
        //sorry to say that this solution was assisted to me
